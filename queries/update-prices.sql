...
WHERE transaction_date = '20/04/2021' AND store = 'hanoi'
  AND product_price < 1000 AND product_price > 0
  AND product_prices < 1000 AND product_price > 0
  AND transaction_total < 1000 AND transaction_total > 0